...
LOGGER_ID_FILE = logger.add("qlaser.log", level="DEBUG", format="[{time:HH:mm:ss} {level}] [{file}:{line}]: {message}", compression="zip", retention=5, backtrace=True,)  # File handler logger ID.
